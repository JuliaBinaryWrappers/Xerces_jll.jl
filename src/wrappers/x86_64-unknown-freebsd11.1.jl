# Autogenerated wrapper script for Xerces_jll for x86_64-unknown-freebsd11.1
export libxerces
...
const libxerces_splitpath = ["lib", "libxerces-c.so"]
...
const libxerces = "libxerces-c-3.2.so"

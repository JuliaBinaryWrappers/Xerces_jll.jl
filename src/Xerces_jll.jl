...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xerces_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("637d83c4-b86a-5d90-b82d-5cf0573a8cfc"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Xerces", artifacts_toml) for e in artifacts["Xerces"]]
...
if best_platform === nothing
    @debug("Unable to load Xerces; unsupported platform $(triplet(platform_key_abi()))")
else
